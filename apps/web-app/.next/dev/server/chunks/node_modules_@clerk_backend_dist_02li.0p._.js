...
;
;
var errorThrower = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$BwjsVTI1$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__y__as__buildErrorThrower$3e$__["buildErrorThrower"])({
...
"[project]/node_modules/@clerk/backend/dist/chunk-J2CDX2WG.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@clerk/backend/dist/chunk-COVYMSO6.mjs [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$ChIG_Ewf$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__u__as__parsePublishableKey$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/shared/dist/runtime/keys-ChIG_Ewf.mjs [middleware] (ecmascript) <export u as parsePublishableKey>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$retry$2d$DqRIhHV5$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__t__as__retry$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/shared/dist/runtime/retry-DqRIhHV5.mjs [middleware] (ecmascript) <export t as retry>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-J2CDX2WG.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RZ7A7F6X$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/backend/dist/chunk-RZ7A7F6X.mjs [middleware] (ecmascript) <locals>");
...
var AuthenticateContext = class {
   ...
   */ get sessionToken() {
    ...
    usesSuffixedCookies() {
        ...
        const { data: sessionData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(session);
        const sessionIat = sessionData?.payload.iat || 0;
        const { data: suffixedSessionData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(suffixedSession);
   ...
   */ isKnownClerkReferrer() {
    ...
    tokenHasIssuer(token) {
        const { data, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
        if (errors) {
            return false;
        }
...
async function fetchJWKSFromBAPI(apiUrl, key, apiVersion) {
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["runtime"].fetch(url.href, {
        headers: {
...
async function resolveKeyAndVerifyJwt(token, kid, options, headerType) {
    try {
        ...
        const { data: payload, errors: verifyErrors } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["verifyJwt"])(token, {
            ...options,
            key,
            ...headerType ? {
                headerType
...
var OrganizationAPI = class extends AbstractAPI {
    ...
    async updateOrganizationLogo(organizationId, params) {
        this.requireId(organizationId);
        const formData = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["runtime"].FormData();
...
function buildRequest(options) {
    const requestFn = async (requestOptions)=>{
        ...
        try {
            if (formData) {
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["runtime"].fetch(finalUrl.href, {
                    method,
                    headers,
                    body: formData
                });
...
function parseErrors(data) {
    if (!!data && typeof data === "object" && "errors" in data) {
        ...
        return errors.length > 0 ? errors.map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$BwjsVTI1$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__T__as__parseError$3e$__["parseError"]) : [];
    }
    return [];
}
function withLegacyRequestReturn(cb) {
    return async (...args)=>{
        ...
        if (errors) {
            const error = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$BwjsVTI1$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__S__as__ClerkAPIResponseError$3e$__["ClerkAPIResponseError"](statusText || "", {
                data: [],
                status,
                clerkTraceId,
                retryAfter
...
async function verifyToken(token, options) {
    const { data: decodedResult, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
    if (errors) {
        return {
            errors
        };
    ...
    try {
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["verifyJwt"])(token, {
            ...options,
            key
        });
    } catch (error) {
...
function handleClerkAPIError(tokenType, err, notFoundMessage) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$BwjsVTI1$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__C__as__isClerkAPIResponseError$3e$__["isClerkAPIResponseError"])(err)) {
        let code;
        let message;
        switch(err.status){
            case 401:
...
async function verifyMachineAuthToken(token, options) {
    if (isJwtFormat(token)) {
        let decodedResult;
        try {
            const { data, errors: decodeErrors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
            if (decodeErrors) {
...
async function verifyHandshakeJwt(token, { key }) {
    const { data: decoded, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(token);
    if (errors) {
        throw errors[0];
    }
    const { header, payload } = decoded;
    const { typ, alg } = header;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["assertHeaderType"])(typ);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["assertHeaderAlgorithm"])(alg);
    const { data: signatureValid, errors: signatureErrors } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["hasValidSignature"])(decoded, key);
    if (signatureErrors) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RZ7A7F6X$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenVerificationError"]({
            reason: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$RZ7A7F6X$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["TokenVerificationErrorReason"].TokenVerificationFailed,
...
var authenticateRequest = async (request, options)=>{
    ...
    async function refreshToken(authenticateContext2) {
        ...
        const { data: decodeResult, errors: decodedErrors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(expiredSessionToken);
    ...
    async function authenticateRequestWithTokenInCookie() {
        ...
        const { data: decodeResult, errors: decodedErrors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$J2CDX2WG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["decodeJwt"])(authenticateContext.sessionTokenInCookie);
        if (decodedErrors) {
...
function createClerkClient(options) {
    ...
    const apiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$COVYMSO6$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createBackendApiClient"])(opts);
    const requestState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$COVYMSO6$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAuthenticateRequest"])({
        options: opts,
        apiClient
    });
...
//# sourceMappingURL=node_modules_%40clerk_backend_dist_02li.0p._.js.map